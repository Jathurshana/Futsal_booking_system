...
<body >
    ...
    <!-- Navigation -->
	  ...
	  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background:#333; font-family:impact; font-size:20px;">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                " <?php
                    ...
                    ?>" 
                style="background: linear-gradient(red,black);
                 font-family:abril fatface; font-size: 25px; color: #fff">
                     PlayMe </a>
            </div>
    ...
    <br><br><br>
	<div style="position: relative; color:#333;left : 6%; font-size: 20px;">
       
		<form name="booking" action="booking.php" method="POST">
    	<p><label>Select Date:</label>
    	<input type = "date" name = "bookdate" style="color:#fff;" value="<?php 
...
<?php
		...
		else
		{
			...
			echo '<div style ="position:relative; top : 20px; left : 5%; margin: 10px; height:90%; width:80%; font-size: 20px;  padding : 3px; color: #333;">
